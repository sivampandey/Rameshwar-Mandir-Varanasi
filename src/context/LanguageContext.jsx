...
export const translations = {
  hi: {
    ...
    home: {
      ...
      historyText: "स्कंद पुराण के काशी खंड के अनुसार, लंका विजय के उपरांत भगवान श्रीराम ने ब्रह्महत्या दोष से मुक्ति हेतु वरुणा तट पर स्वयं बालू से शिवलिंग का निर्माण कर घनघोर तपस्या की थी। वर्तमान लाल बलुआ पत्थर के मंदिर व घाट का निर्माण मराठा शासक सिंधिया राजवंश एवं पुरोहित परिवार द्वारा कराया गया।",
      readMore: "और पढ़ें",
      listenMore: "और सुनें",
    ...
    history: {
      ...
      p3: "ऐतिहासिक रूप से मंदिर का वर्तमान भव्य स्वरूप मराठा वास्तुकला का बेजोड़ नमूना है। 18वीं व 19वीं शताब्दी में ग्वालियर के महाराजा जानकोजी राव सिंधिया, महाराजा जीवाजी राव सिंधिया एवं पुरोहित परिवार ने ग्वालियर के लाल बलुआ पत्थरों से सुंदर मंदिर, नक्काशीदार बालकनी, कोट तथा वरुणा घाट का निर्माण कराया।",
      ...
      item4: "संरक्षक: सिंधिया राजवंश व पुरोहित परिवार",
    },
    // Yatra Page
    yatra: {
    ...
    // Festivals Page
    festivals: {
      title: "वार्षिक पर्व एवं धार्मिक उत्सव",
      sub: "श्री रामेश्वर महादेव मंदिर में वर्ष भर आयोजित होने वाले भव्य मेले एवं उत्सव",
      heading: "प्रमुख वार्षिक धार्मिक उत्सव",
      calendar: "उत्सव कैलेंडर",
      btnTimings: "आरती का समय देखें",
      btnGallery: "उत्सव की तस्वीरें देखें",
    },
    // Admin Panel
    admin: {
      loginTitle: "प्रशासक लॉगिन (Admin Login)",
      loginSub: "वेबसाइट प्रबंधन हेतु यूजर आईडी एवं पासवर्ड दर्ज करें",
      idLabel: "यूजर आईडी (User ID):",
      idPlaceholder: "यूजर आईडी दर्ज करें",
      passLabel: "सुरक्षा पासवर्ड (Password):",
      passPlaceholder: "पासवर्ड दर्ज करें",
      loginBtn: "लॉगिन करें",
      authError: "गलत यूजर आईडी या पासवर्ड! (Invalid Username or Password)",
      authSuccess: "प्रशासक लॉगिन सफल!",
      heroTag: "|| श्री रामेश्वरम प्रबंधन ||",
      heroTitle: "रामेश्वर मंदिर एडमिन पैनल",
      logoutBtn: "लॉगआउट",
      tabGallery: "गैलरी एवं फोटो",
      tabNotice: "समाचार एवं सूचनाएं",
      tabTimings: "आरती एवं दर्शन समय",
      tabFestivals: "प्रमुख उत्सव एवं पर्व",
      uploadTitle: "नई फोटो अपलोड करें",
      uploadSub: "✨ Aspect Ratio Smart Engine: आप किसी भी अनुपात (Vertical 9:16, Horizontal 16:9, Square 1:1) की फोटो अपलोड कर सकते हैं।",
      fileLabel: "फोटो चुनें (Select Image File):",
      previewLabel: "लाइव फोटो पूर्वावलोकन (Live Aspect-Ratio Preview):",
      titleLabel: "फोटो का शीर्षक (Title):",
      catLabel: "श्रेणी (Category):",
      fitLabel: "डिस्प्ले फिट मोड (How Image Displays):",
      captionLabel: "विवरण (Caption/Description):",
      submitUploadBtn: "फोटो अपलोड करें एवं गैलरी में जोड़ें",
      existingTitle: "मौजूद फोटो सूची",
      fitBlur: "🌟 Blur Backdrop (पूरा चित्र बिना कटे दिखे)",
      fitCover: "✂️ Fill Card (कार्ड को पूरा भरे)",
      fitContain: "🖼️ Center Frame (मूल आकार)",
      editBtn: "एडिट",
      deleteBtn: "डिलीट",
      editModalTitle: "फोटो संपादित करें (Edit Image)",
      replaceFileLabel: "नई फोटो फाइल बदलें (Optional Replace File):",
      saveChangesBtn: "परिवर्तन सहेजें",
      cancelBtn: "रद्द करें",
      addNoticeTitle: "नई सूचना या समाचार जोड़ें",
      noticeTitleLabel: "सूचना शीर्षक:",
      noticeTypeLabel: "प्रकार:",
      typeUrgent: "🚨 अति आवश्यक (Urgent / Red Alert)",
      typeInfo: "ℹ️ सामान्य सूचना (General Info / Gold)",
      noticeTextLabel: "सूचना विवरण:",
      publishNoticeBtn: "सूचना प्रकाशित करें",
      activeNoticesTitle: "सक्रिय सूचनाएं",
      saveAllTimingsBtn: "सभी समय सहेजें",
      addFestivalTitle: "नया उत्सव/पर्व जोड़ें",
      festNameLabel: "उत्सव का नाम:",
      festDateLabel: "तिथि/मास:",
      festDescLabel: "विवरण:",
      addFestBtn: "उत्सव जोड़ें",
      festListTitle: "प्रमुख उत्सव सूची"
    },
    // Footer
    footer: {
  ...
  en: {
    ...
    home: {
      ...
      historyText: "According to the Kashi Khanda of Skanda Purana, Lord Shri Rama consecrated a Shivalinga from sand on the Varuna River bank after defeating Ravana to cleanse Brahmahatya dosha. The current red sandstone structure and ghats were built by Maratha rulers of Scindia dynasty and Purohit Parivar.",
      readMore: "Read More",
    ...
    history: {
      ...
      p3: "Historically, the present temple structure is an architectural masterpiece of Maratha design. During the 18th and 19th centuries, Maharaja Jankoji Rao Scindia, Maharaja Jivaji Rao Scindia of Gwalior, and Purohit Parivar constructed the grand temple, carved stone balconies, fortress walls, and Varuna ghats using red sandstone brought from Gwalior.",
      ...
      item4: "Patrons: Scindia Dynasty & Purohit Parivar",
    },
    // Yatra Page
    yatra: {
    ...
    // Festivals Page
    festivals: {
      title: "Annual Festivals & Religious Events",
      sub: "Grand melas and divine celebrations held throughout the year at Shri Rameshwar Mahadev Temple",
      heading: "Major Annual Religious Festivals",
      calendar: "Festival Calendar",
      btnTimings: "View Aarti Timings",
      btnGallery: "View Event Gallery",
    },
    // Admin Panel
    admin: {
      loginTitle: "Admin Panel Login",
      loginSub: "Enter User ID & Password to access temple management portal",
      idLabel: "User ID / Username:",
      idPlaceholder: "Enter User ID",
      passLabel: "Password:",
      passPlaceholder: "Enter Password",
      loginBtn: "Login Now",
      authError: "Invalid Username or Password!",
      authSuccess: "Admin Login Successful!",
      heroTag: "|| Shri Rameshwaram Management ||",
      heroTitle: "Rameshwar Temple Admin Panel",
      logoutBtn: "Logout",
      tabGallery: "Gallery & Photos",
      tabNotice: "Announcements & Notices",
      tabTimings: "Aarti & Darshan Timings",
      tabFestivals: "Festivals & Events",
      uploadTitle: "Upload New Photo",
      uploadSub: "✨ Aspect Ratio Smart Engine: Upload photos in any aspect ratio (Vertical 9:16, Horizontal 16:9, Square 1:1) with zero distortion.",
      fileLabel: "Select Image File:",
      previewLabel: "Live Aspect-Ratio Preview:",
      titleLabel: "Photo Title:",
      catLabel: "Category:",
      fitLabel: "Display Fit Mode:",
      captionLabel: "Caption / Description:",
      submitUploadBtn: "Upload Photo to Gallery",
      existingTitle: "Existing Photos Gallery",
      fitBlur: "🌟 Blur Backdrop (Full photo without crop - Recommended)",
      fitCover: "✂️ Fill Card (Crop)",
      fitContain: "🖼️ Center Frame (Original)",
      editBtn: "Edit",
      deleteBtn: "Delete",
      editModalTitle: "Edit Photo Details",
      replaceFileLabel: "Replace Photo File (Optional):",
      saveChangesBtn: "Save Changes",
      cancelBtn: "Cancel",
      addNoticeTitle: "Add New Announcement or Notice",
      noticeTitleLabel: "Announcement Title:",
      noticeTypeLabel: "Type / Alert Level:",
      typeUrgent: "🚨 Urgent / Red Alert",
      typeInfo: "ℹ️ General Info / Gold Notice",
      noticeTextLabel: "Notice Description:",
      publishNoticeBtn: "Publish Announcement",
      activeNoticesTitle: "Active Announcements",
      saveAllTimingsBtn: "Save All Timings",
      addFestivalTitle: "Add New Festival / Event",
      festNameLabel: "Festival Name:",
      festDateLabel: "Date / Month:",
      festDescLabel: "Description:",
      addFestBtn: "Add Festival",
      festListTitle: "Festival List"
    },
    // Footer
    footer: {
